...
VALUES
    ...
    ('slot2', 'S2', '11:00 AM', '12:00 PM', '2023-10-20'),
    ('slot3', 'S3', '2:00 PM', '3:00 PM', '2023-10-21'),
    ('slot4', 'S4', '3:00 PM', '4:00 PM', '2023-10-21'),
	('slot5', 'S5', '4:00 PM', '5:00 PM', '2023-10-21'),
	('slot6', 'S6', '5:00 PM', '6:00 PM', '2023-10-21');
...
VALUES
    ('detail1', 'booking1', 'status2', 'Service for Pham Minh', 'slot1', 'service1', 'artist1@example.com', NULL, 110.0),
    ('detail2', 'booking2', 'status2', 'Service for Hoang Xuan Quang', 'slot2', 'service2', 'artist2@example.com', NULL, 55.0),
    ('detail3', 'booking3', 'status2', 'Service for Truong Anh Ngoc', 'slot3', 'service3', 'artist3@example.com', NULL, 77.0),
    ('detail4', 'booking4', 'status2', 'Service for Nguyen Dai Nam', 'slot4', 'service4', 'artist4@example.com', NULL, 132.0),
	('detail5', 'booking5', 'status2', 'Service for Tran Anh Tu', 'slot6', 'service5', 'artist5@example.com', NULL, 110.0),
	('detail6', 'booking6', 'status2', 'Service for Tran Ngoc Mai', 'slot6', 'service6', 'artist6@example.com', 'voucher1', 49.5);
